...
CREATE TABLE dbo.hedgeit_deposit_micro_replication (
    ...
    t_bills_eur_formula NVARCHAR(255) NULL
);
GO
...
CREATE TABLE dbo.hedgeit_stock (
    ...
    notional AS (
        CAST(ROUND(CAST(position AS DECIMAL(19, 6)) * traded_price, 0) AS DECIMAL(19, 0))
    ) PERSISTED,

    CONSTRAINT FK_hedgeit_stock_client FOREIGN KEY (client_id) REFERENCES dbo.hedgeit_client (client_id)
);
GO

CREATE TABLE dbo.cash_flow (
    cash_flow_id INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
...
CREATE TABLE dbo.fee_per_line (
    fee_per_line_id INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
    trade_id NVARCHAR(255) NOT NULL, --FK to fut_hedge trade_id
    jan_2025 DECIMAL(19,6) NOT NULL,
    feb_2025 DECIMAL(19,6) NOT NULL,
    mar_2025 DECIMAL(19,6) NOT NULL,
    apr_2025 DECIMAL(19,6) NOT NULL,
    may_2025 DECIMAL(19,6) NOT NULL,
    jun_2025 DECIMAL(19,6) NOT NULL,
    jul_2025 DECIMAL(19,6) NOT NULL,
    aug_2025 DECIMAL(19,6) NOT NULL,
    sep_2025 DECIMAL(19,6) NOT NULL,
    oct_2025 DECIMAL(19,6) NOT NULL,
    nov_2025 DECIMAL(19,6) NOT NULL,
    dec_2025 DECIMAL(19,6) NOT NULL,
    jan_2026 DECIMAL(19,6) NOT NULL,
    feb_2026 DECIMAL(19,6) NOT NULL,
